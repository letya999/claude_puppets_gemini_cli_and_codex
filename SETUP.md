...
2.  **`Switch-Mode.ps1 -Mode [Mode] -Scope [Scope]`**
    Комплексный переключатель между комбинациями (см. таблицу выше). Автоматически настраивает `CLAUDE.md`, JSON-конфиги и копирует необходимые файлы.
3.  **`Install-Dispatcher.ps1`**
